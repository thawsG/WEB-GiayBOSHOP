    ...
    <div class="container">
        <div class="row row-pb-md">
            <div class="col-5 footer-col colorlib-widget ">
                ...
                <h4 class="text-white">Bo Shop - Giày Thể Thao Hà Nội </h4>
                <p class="text-white">
                số 97 đường Quang Tiến - TDP An Thái - Đại Mỗ - Nam Từ Liêm - Hà Nội</p>
            </div>
            ...
            <div class="col-sm-12 text-center">
                <p>
                    <span class="text-white">
                        ...
                        </script> All rights reserved | Design by ThawsG
                    </span>
                </p>
            </div>
        </div>
